...
class JuicerVehicleListPage extends StatefulWidget {
  final Client? client;
  final List<Vehicle> vehicles;

  const JuicerVehicleListPage({Key? key, required this.client, required this.vehicles}) : super(key: key);

  @override
  _JuicerVehicleListPageState createState() => _JuicerVehicleListPageState();
}

class _JuicerVehicleListPageState extends State<JuicerVehicleListPage> {
                ...
                return VehicleCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            VehicleDetailPage(vehicle: vehicle,userRole:"juicer" ,),
                      ),
                    );
                  },
                );
